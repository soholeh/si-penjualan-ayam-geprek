            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>
                            <a class="nav-link" href="daftar_menu.php">Daftar Menu <span class="badge badge-light"><?= $jumlah_menu; ?></span></a>
                        </li>
        ...
        <div class="row mt-5 no-gutters">
            <div class="col-md-3 bg-light">
                <ul class="list-group list-group-flush p-2 pt-4">
                    ...
                    ?>
                    <li class="list-group-item"><a href="cemilan.php" class="text-dark"><i class="fas fa-pizza-slice"></i> Cemilan <span class="badge badge-info"><?= $jumlah_cemilan; ?></span></a></li>
                    <?php 
                    ...
                    ?>
                    <li class="list-group-item"><a href="mkn_berat.php" class="text-dark"><i class="fas fa-utensils"></i> Makanan Berat <span class="badge badge-info"><?= $jumlah_makber; ?></span></a></li>
                    <?php 
                    ...
                    ?>
                    <li class="list-group-item"><a href="minuman.php" class="text-dark"><i class="fas fa-wine-glass-alt"></i> Minuman <span class="badge badge-info"><?= $jumlah_minum; ?></span></a></li>
                </ul>
                <!-- Keranjang -->
                <ul class="list-group list-group-flush p-2 pt-4">
