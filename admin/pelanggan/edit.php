<?php $title = "Ubah Pelanggan | Ge-Ju";
...
<?php
    ...
    if ($pass == $pass_kor) {
        $sql = mysqli_query($koneksi, "UPDATE user SET
            nama = '$nama', email = '$email', telephone = '$telp', alamat = '$alamat', password = '$pass'
            WHERE id_user = '$_GET[id]'");

        echo "<div class='alert alert-info'>Data Pelanggan telah diubah</div>";
...
?>
									...
									<form action="" method="post" enctype="multipart/form-data">
									    <div class="form-group">
									        ...
									        <input type="text" class="form-control" name="nama" value="<?= $user['nama']; ?>" required autofocus>
									    </div>
									    <div class="form-group">
									        <label class="font-weight-bold">Email</label>
									        <input type="eamail" class="form-control" name="email" value="<?= $user['email']; ?>" required>
									    </div>
									    <div class="form-group">
									        <label class="font-weight-bold">Telephone / WA</label>
									        <input type="number" class="form-control" name="telephone" value="<?= $user['telephone']; ?>" required>
									    </div>
									    <div class="form-group">
									        <label class="font-weight-bold">Password</label>
									        <input type="password" class="form-control" name="pass" id="pw" value="<?= $user['password']; ?>" required>
									    </div>
									    <div class="form-group">
